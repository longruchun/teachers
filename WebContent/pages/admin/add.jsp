...
<body>
<div id="container">
    <form method="post" action="${pageContext.request.contextPath }/adminServlet?method=add">
        ...
        <table class="table col-xs-8 table-condensed table-striped" style="margin-top:25px;font-size:small;">
           ...
           <tr>
              ...
              <td>
                  <input type="text" name="name"  class="l360"/>
              </td>
           </tr>
           ...
           <tr>
              ...
              <td>
                 <input type="text" name="password" class="l360"/>
              </td>
           </tr>
           ...
           <tr>
              ...
              <td>
                ...
                <c:forEach items="${roles}" var="role" varStatus="stat">
                   <input type="checkbox" id="${role.id }_" class="roles" name="roles" value="${role.id }">${role.rolename }
