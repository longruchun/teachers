...
<div class="super_container">
	...
	<div class="cart_container">
		<div class="container">
			...
			<%
			    //写小脚本，先取出购物车数据
			    Map<String,Integer> map=(HashMap<String,Integer>)session.getAttribute("CartList");
			    
			    if(map!=null){
			    	IpetBiz biz=new petBiz_jdbcImpl();
			    	for(String s_id:map.keySet()){
			    		Pet pet=biz.getEntityById(Integer.parseInt(s_id));
			%>
				<div class="col">
					<div class="cart_products">
						<ul>
							<li class=" cart_product d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-start">
								<!-- Product Image -->
								<div class="cart_product_image"><img style="height:120px;width:120px;" src="<%=request.getContextPath() %><%=pet.getPhoto() %>" alt=""></div>
								<!-- Product Name -->
								<div class="cart_product_name"><a href="product.html"><%=pet.getName() %></a></div>
								<div class="cart_product_info ml-auto">
									<div class="cart_product_info_inner d-flex flex-row align-items-center justify-content-md-end justify-content-start">
										<!-- Product Price -->
										<div class="cart_product_price">$<%=pet.getPrice() %></div>
										<!-- Product Quantity -->
										<div class="product_quantity_container">
											<div class="product_quantity clearfix">
												<input id="quantity_input" type="text" pattern="[0-9]*" value="<%=map.get(s_id) %>">
										...
										<div class="cart_product_total">$<%=pet.getPrice()*map.get(s_id) %></div>
