				...
				<div class="col-lg-4 product_col">
					<div class="product">
						<div class="product_image">
							<img style="width:360px;height:420px;" src="<%=request.getContextPath() %><%=pet.getPhoto() %>" alt="">
						</div>
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="product.html"><%=pet.getName() %></a></div>
								<div class="product_price">$<%=pet.getPrice() %></div>
							</div>
							<div class="product_options">
								<div class="product_buy product_option cartitem" id="<%=pet.getId() %>"><img src="<%=request.getContextPath() %><%=pet.getPhoto() %>" alt="加入购物车" title="求带走"></div>
			...
			<script>
			    $(function(){
			    	$(".cartitem").click(function(){
			    		...
			    		$.post("<%=request.getContextPath()%>/pages/business/addcart.jsp",{"petid":petid},function(data){
